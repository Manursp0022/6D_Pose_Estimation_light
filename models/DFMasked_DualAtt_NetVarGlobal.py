...
class DenseFusion_Masked_DualAtt_NetVarGlobal(nn.Module):
    ...
    def _forward_fusion(self, rgb, depth, mask=None):
        ...
        return fused_feat, rgb_feat

    def _global_pooling(self, fused_feat, batch_size, rgb_feat, bb_info,cam_params):
        ...
        # GLOBAL AVERAGE POOLING (Instead of weighted)
    ...
    def forward(self, rgb, depth,bb_info, cam_params, mask=None):
        ...
        pred_r, pred_t= self._global_pooling(fused_feat, bs, rgb_feat, bb_info, cam_params)
